...
function loadNewsData(){
  ...
  let _this=arguments[0]._this;
  let isRequest=_this.getAttribute('data-request');
  let boxs=document.querySelectorAll(".news-wrap .box");
  let idx=arguments[0].idx;
  ...
  // arguments[0]._this.setAttribute('data-request',true);
  let menus=document.querySelectorAll('.tab-menu>a');
  menus.forEach(item=>{
    item.className='';
  })
